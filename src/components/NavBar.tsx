  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50 bg-white">
      <nav
        ...
        <div className="flex lg:flex-1 text-gray-800">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Operacion Bigotes</span>
            Operacion Bigotes
          </Link>
        </div>
      ...
      <Dialog
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-100 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
